...
```{python ipub={'figure': {'caption': 'An example beeswarm plot of the built-in `tips` dataset found in seaborn', 'height': 0.4, 'label': 'fig:example', 'placement': 'H', 'widefigure': False}}}
