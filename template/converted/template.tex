...
\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.3\paperheight}{template_files/output_10_0.pdf}\end{center}\caption{An example beeswarm plot of the built-in `tips` dataset found in seaborn}\label{fig:example}
    \end{figure}
